...
* Objective
  - To perform the Experiment of the "To determine the overall heat transfer coefficient (U) in the parallel flow heat exchanger" experiment
...
* Pre conditions
  - 1. Open the url vlabs.ac.in and vlabs home page is displayed 
    ...
    4. Selected  "To determine the overall heat transfer coefficient (U) in the parallel flow heat exchanger" experiment.
