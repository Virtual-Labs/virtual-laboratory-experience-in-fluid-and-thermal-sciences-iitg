...
* Objective
  - To download the software packages of the Flow through Venturi meter experiment
...
* Pre conditions
  - 1. Open the url vlabs.ac.in and vlabs home page is displayed 
    ...
    4. Selected  "Flow through Venturi meter" experiment and click on the "Software Package" of the Experiment.
